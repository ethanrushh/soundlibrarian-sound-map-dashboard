...
export const Route = createFileRoute('/dashboard/pins/all')({
...
function RouteComponent() {
    ...
    async function fetchPins() {
        try {
            const pins = await axios.get<AdminPin[]>(apiUrl() + '/dashboard/all-pins', {
    ...
    return (
        <div>
            <h1 className='text-center font-bold text-3xl mb-10'>All Pins</h1>

            {
                loading ? (
                    ...
                    pins === null || error ? (
                        ...
                        pins.length <= 0 ? (
                            <p className='text-center'>There are no pins to view.</p>
                        ) : (
